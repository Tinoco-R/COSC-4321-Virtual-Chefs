 ...
 */
 ...
 namespace Oculus.Interaction
 {
    ...
    /// </summary>
    public class GrabbableWithNoGravity : PointableElement, IGrabbable
    {
        /// <summary>
        ...
        [Tooltip("The handler that will define the position of the object grabbed once it's released")]
        ...
        private void UpdateTransform()
        {
            ...
            // If the distance between the Handle and the Grabbable Handle is bigger than 0.4f then force the release of the object
            if (Vector3.Distance(handler.position, _targetTransform.position) > 0.4f)
            {
                // Call the OnDisable method to cancel all active selecting points
                OnDisable();
            }
        ...
        private void EndTransform()
        {
            ...
            // Set the grabbed object's transform to the handler's transform
            if (handler != null)
            {
                _targetTransform.position = handler.position;
                _targetTransform.rotation = handler.rotation;

                // Get the Rigidbody component of the grabbed object
                Rigidbody handlerRigidbody = handler.GetComponent<Rigidbody>();
